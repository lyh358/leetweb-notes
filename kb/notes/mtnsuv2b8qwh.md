...
把对象的创建逻辑抽离到工厂类，客户端不用直接 new 对象，只使用。
### 1. 简单工厂
...
表格对比简单工厂抽象工厂工厂数量**只有 1 个工厂类**多个工厂，抽象工厂基类 + 多个具体工厂生产能力一次只生产**单个种类对象**生产**一组相互配套的产品族**开闭原则新增产品要修改工厂代码，违反开闭新增产品族只需新增工厂类，符合开闭；新增产品接口要改抽象工厂耦合工厂类臃肿，所有创建逻辑堆在一起产品族内的产品配套，隔离不同产品系列**
