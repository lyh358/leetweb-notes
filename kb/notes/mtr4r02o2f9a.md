...
## I developed firmware for a =={yellow}smart beehive terminal using FreeRTOS and the ESP32 develop kit==. Other work includes an edged‑AI system for battery life prediction, as well as distributed communication middleware for robots built upon ROS, Protobuf and gRPC.
