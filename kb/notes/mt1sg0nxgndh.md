...
|  | =={yellow}启动模式选择引脚== |  |  |  | =={yellow}启动模式== |  | =={yellow}说明== |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | =={yellow}BOOT1== |  | =={yellow}BOOT0== |  |  |  |  |  |
|  | =={yellow}X== |  | =={yellow}0== |  | =={yellow}主闪存存储器== |  | =={yellow}主闪存存储器被选为启动区域== |  |
|  | =={yellow}0== |  | =={yellow}1== |  | =={yellow}系统存储器== |  | =={yellow}系统存储器被选为启动区域== |  |
|  | =={yellow}1== |  | =={yellow}1== |  | =={yellow}内置 SRAM== |  | =={yellow}内置 SRAM 被选为启动区域== |  |
