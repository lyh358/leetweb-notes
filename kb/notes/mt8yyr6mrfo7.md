...
**=={green}标准化的目的==**不是改变特征之间的退化关系，而是=={yellow}消除==电压、电流、温度和时间等****=={yellow}******不同特征**因为**量纲**造成的**数值尺度差异**==，=={yellow}避免**数值范围较大的特征**在PCA和模型训练中**占据过大权重**。==
...
LSTM在**=={pink}RNN基础上==**=={pink}增加了==**=={pink}细胞状态==**=={pink}以及==**=={pink}遗忘门==********=={pink}、==****=={pink}输入门==**=={pink}和==******=={pink}输出门==**=={pink}：==
