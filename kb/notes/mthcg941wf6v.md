...
│                             AI‑Core                                          │
│                                                                              │
│  Scalar Unit(标量控制)  指令队列，下发MTE/Cube/Vector指令                     │
│      │                                                                        │
│      ▼                                                                        │
│  ┌─────┬──────┬──────┬──────────────┐                                        │
│  │MTE1 │ MTE2 │ MTE3 │ FixPipe      │◄──────数据搬运引擎                     │
│  └──┬──┴──┬───┴──┬───┴───────┬──────┘                                        │
│     │     │      │           │                                               │
│     │     │      │           │                     ┌────────────┐            │
│     │     │      │           └────────────────────►│  Cube Unit │            │
...
│     │     │      │                                       ▼                   │
│  ┌──▼──┐ ┌▼────┐ │  ┌──────────┐                  ┌────┴────┐               │
│  │L0A  │ │L0B  │ │  │ L1 Buffer│                  │ L0C     │               │
│  │Cube左输入││Cube右输入│  │AI‑Core私有大缓存│      │Cube结果输出│               │
│  └─────┘ └─────┘ │  └─────┬────┘                  └────┬────┘               │
│        ▲          │        │                           │                    │
│        │ MTE1     │ MTE2   │                           │ FixPipe            │
│        └──────────┘        │                           ▼                    │
...
└─────────────────────────────────────────────────────────┼────────────────────┘
                                                          ▼
┌──────────────────────────────────────────────────────────────────────────────┐
│  L2 Cache (AI‑Core集群共享，不是单个AI‑Core私有)                               │
└──────────────────────────────────────────────────────────────────────────────┘
                                                          ▼ MTE2/MTE3
┌──────────────────────────────────────────────────────────────────────────────┐
│  GM Global Memory (LPDDR4 全局内存)                                           │
└──────────────────────────────────────────────────────────────────────────────┘
