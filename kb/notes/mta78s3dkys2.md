...
**精度是硬约束**：5G L1对信道估计精度有严格协议要求，任何数学不等价的近似都有可能导致系统级性能降级**模型已很小**：4层Transformer、32×32矩阵，**没有冗余可剪**维度由协议决定：slot数、RB数、天线数都是5G标准规定的，不可随意缩减ATC融合优先：即使找到数学等价的替换方案，如果破坏了ATC的融合模式，也会像P1一样反向优化
