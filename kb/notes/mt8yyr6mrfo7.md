...
当前**=={green}ONNX模型==**=={green}经过检查，主要包含==**=={green}LSTM==**=={green}、==**=={green}Transpose==**=={green}、==**=={green}Squeeze==**=={green}、==**=={green}Gather===={green}r==**=={green}和==**=={green}Gemm==**=={green}等算子，==计算图结构相对简单。
