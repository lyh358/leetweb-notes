...
=={yellow}项目中==**=={yellow}前===={yellow}四个主成分==**=={yellow}的==**=={yellow}累计方差贡献率===={yellow}达到===={yellow}98.65%==**=={yellow}，因此===={yellow}将9维特征===={yellow}压缩成==**=={yellow}4维健康因子==**=={yellow}，作为==**=={yellow}LSTM的输入。==**
